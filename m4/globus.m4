...
dnl - GLOBUS_FTP_CONTROL_NOTHR_LIBS
dnl   GLOBUS_FTP_CONTROL_THR_LIBS
...
[
    ...
    [],
        with_globus_nothr_flavor=${GLOBUS_NOTHR_FLAVOR:-gcc32dbg})
    ...
    AC_ARG_WITH(globus_thr_flavor,
        ...
        [],
        with_globus_thr_flavor=${GLOBUS_THR_FLAVOR:-gcc32dbgpthr})
    ...
    GLOBUS_FTP_CONTROL_NOTHR_LIBS="$ac_globus_ldlib -lglobus_ftp_control_$with_globus_nothr_flavor"
    GLOBUS_FTP_CONTROL_THR_LIBS="$ac_globus_ldlib -lglobus_ftp_control_$with_globus_thr_flavor"
    ...
    if test -n "$ac_globus_point_version" ; then
        ...
        GLOBUS_FTP_CONTROL_NOTHR_LIBS=""
        GLOBUS_FTP_CONTROL_THR_LIBS=""
    ...
    AC_SUBST(GLOBUS_FTP_CONTROL_NOTHR_LIBS)
    AC_SUBST(GLOBUS_FTP_CONTROL_THR_LIBS)
